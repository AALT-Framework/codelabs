...
GitHub Copilot: Clonando o projeto do aplicativo Contador do GitHub três vezes, em diferentes pastas para cada ferramenta:
...
6. Agora você tem três cópias do projeto, cada uma em uma pasta diferente.

Clonando o projeto do aplicativo Contador do GitHub uma vez e criando três branches diferentes, uma para cada ferramenta:
1. Abra o terminal ou prompt de comando no diretório onde deseja clonar o projeto.
2. Digite o seguinte comando: `git clone https://github.com/AALT-Framework/poor-accessibility-apps.git`
3. Isso irá clonar o repositório inteiro. Navegue até a pasta "Contador" dentro do repositório clonado.
4. Digite o seguinte comando para criar um novo branch para a primeira ferramenta: `git checkout -b ferramenta1`
5. Faça as alterações necessárias para testar a primeira ferramenta.
6. Digite o seguinte comando para criar um novo branch para a segunda ferramenta: `git checkout -b ferramenta2`
7. Faça as alterações necessárias para testar a segunda ferramenta.
8. Digite o seguinte comando para criar um novo branch para a terceira ferramenta: `git checkout -b ferramenta3`
9. Faça as alterações necessárias para testar a terceira ferramenta.
