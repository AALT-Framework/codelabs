...
Para promover essa capacitação, serão apresentados brevemente alguns conceitos teóricos sobre acessibilidade, com ênfase na acessibilidade em aplicativos móveis, onde serão apresentados os principais problemas de acessibilidade reportados na literatura, os guias e recomendações disponíveis para auxiliar na eliminação dessas barreiras de acessibilidade e as diferentes abordagens de testes de acessibilidade.
