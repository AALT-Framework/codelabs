...
2. Clonar o projeto do aplicativo Contador do GitHub uma vez e criar três _branches_ diferentes, uma para cada ferramenta.
    ...
    3. Isso irá clonar o repositório inteiro. Entre na pasta "poor-accessibility-apps" e crie uma nova branch para cada ferramenta.
        4. Digite o seguinte comando para criar um novo branch para o Accessibility Scanner: `git checkout -b Contador-AccessibilityScanner`
        5. Digite o seguinte comando para criar um novo branch para o Espresso: `git checkout -b Contador-Espresso`
        6. Digite o seguinte comando para criar um novo branch para o AATK: `git checkout -b Contador-AATK`
