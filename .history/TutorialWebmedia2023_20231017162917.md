...
1. Clonar o projeto do aplicativo Contador do GitHub três vezes, em diferentes pastas para cada ferramenta.
    ...
    3. Crie uma cópia da pasta "Contador", que está dentro do repositório clonado, para cada projeto. Nomeie cada cópia de acordo com a ferramenta que você deseja testar, da seguinte forma:
        ...
        - Contador-Espresso
        - Contador-AATK
    4. Agora você tem três cópias do projeto, uma para cada ferramenta.
    5. Para cada ferramenta, abra a respectiva pasta do projeto no Android Studio e siga as instruções do tutorial.
...
2. Clonar o projeto do aplicativo Contador do GitHub uma vez e criar três _branches_ diferentes, uma para cada ferramenta.
    1. Abra o terminal ou prompt de comando no diretório onde deseja clonar o projeto.
    2. Digite o seguinte comando: `git clone https://github.com/AALT-Framework/poor-accessibility-apps.git`
    3. Isso irá clonar o repositório inteiro. Entre na pasta "poor-accessibility-apps" e crie uma nova branch para cada ferramenta.
        1. Digite o seguinte comando para criar um novo branch para o Accessibility Scanner: `git checkout -b Contador-AccessibilityScanner`
        2. Digite o seguinte comando para criar um novo branch para o Espresso: `git checkout -b Contador-Espresso`
        3. Digite o seguinte comando para criar um novo branch para o AATK: `git checkout -b Contador-AATK`
    10. Agora você tem três branches diferentes, uma para cada ferramenta.
    5. Para cada ferramenta, abra a respectiva pasta do projeto no Android Studio e siga as instruções do tutorial.
