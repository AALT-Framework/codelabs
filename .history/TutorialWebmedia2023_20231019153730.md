...
<aside>Por que áreas de toque pequenas são um problema para a acessibilidade? Muitas pessoas têm dificuldade para focar em áreas de toque pequenas na tela. Isso pode acontecer por terem dedos grandes ou alguma condição médica que afeta as habilidades motoras delas. As áreas de toque pequenas também dificultam para os usuários de leitor de tela navegarem em apps movendo um dedo na tela, como durante o uso do recurso Explorar por toque no TalkBack.
