...
<aside>
**ATENÇÃO!** Se você for utilizar seu próprio smartphone e não souber como habilitar o modo de desenvolvedor, siga as instruções [deste tutorial](https://developer.android.com/studio/debug/dev-options). Caso opte por utilizar o emulador, siga as instruções [deste tutorial](https://developer.android.com/studio/run/emulator). Chame o instrutor se precisar de ajuda.
<a href="https://developer.android.com/studio/debug/dev-options">deste tutorial</a>
</aside>
