...
<aside>
<b>Afinal, o que é um contraste adequado?</b> As <a href="https://www.w3.org/WAI/standards-guidelines/wcag/" target="_" [diretrizes de acessibilidade de conteúdo da Web]() recomendam uma [proporção de contraste mínima](http://www.w3.org/TR/UNDERSTANDING-WCAG20/visual-audio-contrast-contrast.html) de 4.5:1 para todo o texto. A proporção de 3.0:1 é considerada aceitável para textos grandes ou em negrito. Tente usar essas taxas, ou maiores, nos seus aplicativos.
</aside>
