...
6. Digite o seguinte comando para criar um novo branch para a segunda ferramenta: `git checkout -b Contador-Espresso`
7. Faça as alterações necessárias para testar a segunda ferramenta.
8. Digite o seguinte comando para criar um novo branch para a terceira ferramenta: `git checkout -b Contador-AATK`
