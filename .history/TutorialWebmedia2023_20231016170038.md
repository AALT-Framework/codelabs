...
* **AATK**: kit de testes de acessibilidade automatizados para Android. Contém cinco testes de acessibilidade que podem ser executados sem a necessidade de dispositivo físico
ou emulado.
