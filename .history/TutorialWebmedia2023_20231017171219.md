...
Faça o download do Scanner de acessibilidade na Google Play Store.
Após instalar o Scanner de acessibilidade, navegue até Configurações > Acessibilidade no dispositivo**.** Localize e ative o Scanner de acessibilidade (toque em "**Permitir**" ou "**OK**" e, em seguida, em "**Iniciar autorização**" para concluir o fluxo de configuração).
Retorne ao app Counter. Sua tela estará assim: