...
Em algumas circunstâncias, áreas de toque inadequadas tornam apps menos acessíveis para todos os usuários, e não apenas aqueles com necessidades de acessibilidade.

No caso dos botões aumentar/diminuir, a área de toque é pequena até mesmo para um usuário com habilidades motoras excelentes. Se alguém tocar rapidamente em um dos botões por alguns segundos, pode perceber que alguns dos toques não foram registrados. Se o usuário fizer isso enquanto anda, com uma precisão de toque reduzida, a experiência pode se tornar ainda mais desafiadora.

Lembre-se: esse tipo de recurso ajuda todos os usuários, não apenas aqueles com necessidades de acessibilidade.
</aside>
...
| Antes | Depois |
|-------|--------|
| ![Tela do app Counter sem contraste melhorado](images/contador_contraste1.png) | ![Tela do app Counter com contraste melhorado](images/contador_contraste2.png) |
