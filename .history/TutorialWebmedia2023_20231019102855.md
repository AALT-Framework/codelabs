...
<aside>
O Scanner de acessibilidade ajuda a identificar problemas de contraste de cor em um app em funcionamento. No entanto, é melhor considerar esses problemas durante a criação da paleta de cores do seu app. Você pode usar um dos vários verificadores de contraste disponíveis on-line para conferir as suas proporções de contraste.
</aside>
