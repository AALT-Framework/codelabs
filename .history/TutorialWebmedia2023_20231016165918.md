...
* Accessibility Scanner: ferramenta desenvolvida pelo Google que verifica aplicativos móveis em busca de problemas de acessibilidade. Instalável como um aplicativo, quando habilitado ele permite analisar a interface de qualquer outro app em primeiro plano e oferecer sugestões e soluções para melhorar a acessibilidade.
