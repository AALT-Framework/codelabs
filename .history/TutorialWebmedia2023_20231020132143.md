...
* **AATK (Kit de Testes de Acessibilidade Automatizados)**: uma biblioteca Android contendo testes de acessibilidade automatizados locais, ou seja, que não requerem uso de disposivi
